...
export function CompanyListPage(props: CompanyListPageProps) {
    ...
    async () =>
      getCompanies({
        ...
        searchTermKeys: [
          ...
          'company_website.contains',
          'company_headquarters.contains',
          'company_ceo.contains',
        ],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'company_website', header: 'Company Website', accessorKey: 'company_website' },
    { id: 'company_headquarters', header: 'Company Headquarters', accessorKey: 'company_headquarters' },
    { id: 'company_rating', header: 'Company Rating', accessorKey: 'company_rating' },
    { id: 'company_ceo', header: 'Company Ceo', accessorKey: 'company_ceo' },
