  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unlock the Power of Efficiency with HR Management Application: Streamlining Your Human Resource Processes for Optimal Business Performance"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unlock the Power of Efficiency with HR Management Application: Streamlining Your Human Resource Processes for Optimal Business Performance`}
            </Text>
            <Box
